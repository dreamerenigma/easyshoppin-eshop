            ...
            children: [
              SizedBox(
                ...
                child: TAnimationLoaderWidget(
                  text: '',
                  animation: TImages.favoriteStores,
                  showAction: false,
                  actionText: '',
                  onActionPressed: () {},
                ),
              ),
              Text(S.of(context).favoriteStoresListEmpty, style: Theme.of(context).textTheme.headlineSmall),
              const SizedBox(height: 20),
              ElevatedButton(
                onPressed: () => Get.off(() => const NavigationMenu()),
                style: ElevatedButton.styleFrom(padding: const EdgeInsets.symmetric(horizontal: 32.0, vertical: 16.0)),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(order.orderStatusText, overflow: TextOverflow.ellipsis,
                            ...
                            Flexible(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(order.id, overflow: TextOverflow.ellipsis, style: Theme.of(context).textTheme.titleMedium),
                                ],
                              ),
                            ),
                          ],
