...
import 'package:easyshoppin_eshop/common/widgets/products/ratings/rating_indicator.dart';
            ...
            child: Column(
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("Easy Shoppin Store", style: Theme.of(context).textTheme.titleMedium),
