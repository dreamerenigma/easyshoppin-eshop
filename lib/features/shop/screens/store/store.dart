  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: TAppBar(title: Text(S.of(context).store, style: Theme.of(context).textTheme.headlineMedium)),
        body: NestedScrollView(
          ...
          headerSliverBuilder: (_, innerBoxIsScrolled) {
            return [
              SliverAppBar(
                ...
                backgroundColor: THelperFunctions.isDarkMode(context) ? TColors.youngNight : TColors.white,
                flexibleSpace: ListView(
                  ...
                  children: [
                    /// --- Search bar
                    Padding(
                      padding: const EdgeInsets.only(left: TSizes.spaceBtwDefault, right: TSizes.spaceBtwDefault, top: TSizes.spaceBtwDefault),
                      child: const TSearchContainer(showBorder: true, showBackground: false, padding: EdgeInsets.zero),
                    ),
                    ...
                    const SizedBox(height: TSizes.spaceBtwItems / 1),
                    /// -- Brands GRID
                    Padding(
          ...
          body: ScrollConfiguration(
            ...
            child: TabBarView(children: categories.map((category) => TCategoryTab(category: category)).toList()),
          ),
        ),
      ),
    );
