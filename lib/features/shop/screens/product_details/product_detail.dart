          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                /// 2 - Product Details
                Padding(
                  padding: const EdgeInsets.only(left: TSizes.spaceBtwItems, right: TSizes.spaceBtwItems, bottom: TSizes.spaceBtwItems),
                  child: Column(
                    children: [
                      /// Rating & Share Button
                      ...
                      /// -- Attributes
                      if (widget.product.productType == ProductType.variable.toString()) TProductAttributes(product: widget.product),
                      if (widget.product.productType == ProductType.variable.toString()) const SizedBox(height: TSizes.spaceBtwSections),
                      /// -- Checkout Button
