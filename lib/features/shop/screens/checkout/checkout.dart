...
import 'package:easyshoppin_eshop/features/shop/screens/checkout/widgets/billing_address_section.dart';
import 'package:easyshoppin_eshop/features/shop/screens/checkout/widgets/billing_amount_section.dart';
import 'package:easyshoppin_eshop/features/shop/screens/checkout/widgets/billing_payment_section.dart';
...
class CheckoutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final totalAmount = TPricingCalculator.calculateTotalPrice(subTotal, 'RU');
          ...
          child: Column(
            children: [
              ...
              TRoundedContainer(
                ...
                backgroundColor: dark ? TColors.youngNight : TColors.white,
                child: const Column(
                  children: [
                    /// Pricing
