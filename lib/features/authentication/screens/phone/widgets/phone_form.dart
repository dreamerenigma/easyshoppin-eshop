...
class TPhoneFormState extends State<TPhoneForm> {
  ...
  void _sendVerificationCode() async {
    ...
    final fullPhoneNumber = "${countries[_selectedCountryIndex].code}$phoneNumber";
    ...
    void navigateToVerificationScreen(String verificationId) {
      Navigator.push(
        context,
        createPageRoute(VerificationPhoneScreen(verificationId: verificationId)),
      );
    }
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                  ...
                  child: Row(
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Image.asset(
                          countries[_selectedCountryIndex].flag,
                          width: 24,
                          height: 24,
                        ),
                      ),
                ...
                prefixText: "${countries[_selectedCountryIndex].code} ",
