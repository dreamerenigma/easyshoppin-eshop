...
import 'package:easyshoppin_eshop/features/personalization/screens/privacy_policy/widgets/privacy_files_cookies.dart';
...
class PrivacyPolicyScreenState extends State<PrivacyPolicyScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: TAppBar(
        title: Text(S.of(context).privacyPolicy, style: const TextStyle(fontSize: TSizes.fontSizeBg)),
        showBackArrow: true,
      ),
        ...
        child: Padding(
          ...
          child: ListView(
            children: [
              ...
              const Divider(),
              AnimatedExpansionTile(
                title: S.of(context).cookies,
                children: const [PrivacyFilesCookies()],
              ),
              const Divider(),
              AnimatedExpansionTile(
