...
import 'widgets/tabs/second_tab_content.dart';
...
class CouponScreenState extends State<CouponScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: TAppBar(
        showBackArrow: true,
        title: Text(S.of(context).titleCoupons, style: const TextStyle(fontSize: TSizes.fontSizeXl)),
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(S.of(context).subtitleCouponsOrder, style: Theme.of(context).textTheme.labelMedium),
            const SizedBox(height: TSizes.spaceBtwSections),
            Container(
              decoration: const BoxDecoration(
                border: Border(bottom: BorderSide(color: TColors.transparent)),
              ),
              child: Row(
                children: [
