...
class ChangeDataBirth extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: TAppBar(
        showBackArrow: true,
        title: Text(S.of(context).titleChangeDateBirth, style: TextStyle(fontSize: TSizes.fontSizeBg)),
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(S.of(context).subTitleChangeDateBirth, style: Theme.of(context).textTheme.labelMedium),
                            ...
                            children: [
                              ...
                              Obx(() => SizedBox(
                                ...
                                child: DropdownButton<String>(
                                  ...
                                  dropdownColor: TColors.blackGrey,
                                ),
                              )),
                            ],
                          ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () => controller.updateDateBirth(context),
