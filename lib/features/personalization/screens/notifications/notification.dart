            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style: const TextStyle(fontWeight: FontWeight.bold, fontSize: TSizes.fontSizeMd),
                ),
                const SizedBox(height: 10),
                Text(S.of(context).notificationScammers, style: const TextStyle(fontSize: TSizes.fontSizeSm)),
              ],
            ),
          ),
        ],
