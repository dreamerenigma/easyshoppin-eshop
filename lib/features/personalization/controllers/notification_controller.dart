...
class NotificationController extends GetxController {
  ...
  var isSwitchedNotifications = false.obs;
  var isSwitchedPersonalAccount = false.obs;
  ...
  Future<void> loadSwitchStates() async {
    isSwitchedNotifications.value = storage.read('isSwitchedNotifications') ?? false;
    isSwitchedPersonalAccount.value = storage.read('isSwitchedPersonalAccount') ?? false;
  }
  ...
  Future<void> handleSwitchChange(bool value) async {
    isSwitchedNotifications.value = value;
    ...
    storage.write('isSwitchedNotifications', value);
  }
  ...
  Future<void> handleSwitchPersonalAccount(bool value) async {
    isSwitchedPersonalAccount.value = value;

    if (value) {
      await FirebaseMessaging.instance.subscribeToTopic('personalAccount');
    } else {
      await FirebaseMessaging.instance.unsubscribeFromTopic('personalAccount');
    }

    storage.write('isSwitchedPersonalAccount', value);
  }
}
