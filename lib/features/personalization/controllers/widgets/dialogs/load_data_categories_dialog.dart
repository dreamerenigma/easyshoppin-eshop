...
void loadDataCategoriesDialog(BuildContext context) {
  showDialog(
    context: context,
          ...
          child: Material(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    S.of(context).loadCategoryData,
                    style: Theme.of(context).textTheme.headlineSmall,
                    textAlign: TextAlign.start,
                  ),
                  const SizedBox(height: TSizes.spaceBtwItems),
                  Text(
                    S.of(context).uploadCategoryDatabase,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ElevatedButton(
                          onPressed: () async {
                            await LoadDataController.uploadCategoriesAndSubCategories(context);
                            if (context.mounted) {
