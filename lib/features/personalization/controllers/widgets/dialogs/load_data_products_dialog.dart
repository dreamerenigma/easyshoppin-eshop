...
void loadDataProductsDialog(BuildContext context) {
  showDialog(
    context: context,
          ...
          child: Material(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    S.of(context).loadProductData,
                    style: Theme.of(context).textTheme.headlineSmall,
                    textAlign: TextAlign.start,
                  ),
                  const SizedBox(height: TSizes.spaceBtwItems),
                  Text(
                    S.of(context).uploadProductDatabase,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ElevatedButton(
                          onPressed: () async {
                            await LoadDataController.uploadProducts(context);
                            if (context.mounted) {
