...
import '../features/personalization/screens/profile/screens/profile.dart';
import '../features/personalization/screens/settings/profile_screen.dart';
import '../features/shop/screens/home/home_screen.dart';
import '../features/splash_screen/screens/splash_screen.dart';

class AppRoutes {
  static final pages = [
    GetPage(name: TRoutes.splash, page: () => const SplashScreen(), transition: Transition.fade),
